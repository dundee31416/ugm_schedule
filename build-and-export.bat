@echo off
REM UGM Schedule - Build and Export Docker Images (Windows)
REM This script builds production images and saves them to tar files for transfer
...
REM Create output directory for tar files
...
REM Build frontend image (production target)
